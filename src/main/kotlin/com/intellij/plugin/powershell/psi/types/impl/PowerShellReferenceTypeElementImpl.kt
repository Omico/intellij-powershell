...
open class PowerShellReferenceTypeElementImpl(node: ASTNode) :
    PowerShellReferencePsiElementImpl(node),
    PowerShellReferenceTypeElement,
    ...
    override fun getQualifier(): PowerShellReferenceTypeElement? =
        findChildByClass(PowerShellReferenceTypeElement::class.java)
