...
abstract class PowerShellQualifiedReferenceElementImpl<out Q : PowerShellPsiElement>(node: ASTNode) :
    PowerShellReferencePsiElementImpl(node), PowerShellQualifiedReferenceElement<Q> {
