...
abstract class PowerShellPropertyImpl(node: ASTNode) :
    PowerShellTargetVariableImpl(node),
    PowerShellMemberDeclaration,
    PowerShellAttributesHolder {
    ...
    private fun getVariable(): PowerShellVariable? =
        findChildByClass(PowerShellTargetVariableExpression::class.java) ?: findFirstAssignmentTarget()
