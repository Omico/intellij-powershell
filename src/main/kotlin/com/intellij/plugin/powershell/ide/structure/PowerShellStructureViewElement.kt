...
class PowerShellStructureViewElement(element: PowerShellPsiElement) :
    PsiTreeElementBase<PowerShellPsiElement>(element),
    ItemPresentation,
    ...
    override fun getChildrenBase(): MutableCollection<StructureViewTreeElement> {
        ...
        when (myElement) {
            is PowerShellFile -> {
                ...
                PowerShellResolveUtil.processChildDeclarations(
                    myElement,
                    resolveProcessor,
            ...
            is PowerShellClassDeclarationStatement -> PowerShellResolveUtil.processClassMembers(
                myElement,
                resolveProcessor,
                ResolveState.initial(),
                null,
            ...
            is PowerShellEnumDeclarationStatement -> PowerShellResolveUtil.processEnumMembers(
                myElement,
                resolveProcessor,
                ResolveState.initial(),
                null,
    ...
    private fun isRoot(e: PowerShellPsiElement) =
        e is PowerShellClassDeclarationStatement || e is PowerShellEnumDeclarationStatement
