...
class PowerShellSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    companion object {
        ...
        val COMMAND_NAME =
            createTextAttributesKey(POWER_SHELL_COMMAND_NAME, DefaultLanguageHighlighterColors.MARKUP_ATTRIBUTE)
        val COMMAND_PARAMETER =
            createTextAttributesKey(POWER_SHELL_COMMAND_PARAMETER, DefaultLanguageHighlighterColors.PREDEFINED_SYMBOL)
        val TYPE_NAME = createTextAttributesKey(POWER_SHELL_TYPE_NAME, DefaultLanguageHighlighterColors.CLASS_NAME)
        val TYPE_REFERENCE =
            createTextAttributesKey(POWER_SHELL_TYPE_REFERENCE, DefaultLanguageHighlighterColors.CLASS_REFERENCE)
        val VARIABLE_NAME =
            createTextAttributesKey(POWER_SHELL_VARIABLE, DefaultLanguageHighlighterColors.LOCAL_VARIABLE)
        val PROPERTY_REFERENCE =
            createTextAttributesKey(POWER_SHELL_PROPERTY_REF_NAME, DefaultLanguageHighlighterColors.IDENTIFIER)
        val METHOD_CALL =
            createTextAttributesKey(POWER_SHELL_METHOD_CALL_NAME, DefaultLanguageHighlighterColors.FUNCTION_CALL)
        val METHOD_DECLARATION = createTextAttributesKey(
