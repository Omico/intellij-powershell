...
class SyntheticPowerShellCodeBlock(
    private val mySubBlocks: MutableList<Block>,
    private val myBlockAlignment: Alignment?,
    private val myBlockIndent: Indent,
    private val myBlockWrap: Wrap?,
) : PowerShellCodeBlock {

    override fun getNode(): ASTNode? = null

    private val myBlockTextRange =
        TextRange(mySubBlocks[0].textRange.startOffset, mySubBlocks[mySubBlocks.size - 1].textRange.endOffset)
