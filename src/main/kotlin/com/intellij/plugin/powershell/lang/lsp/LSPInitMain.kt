...
class LSPInitMain : PersistentStateComponent<LSPInitMain.PowerShellInfo>, Disposable {
    ...
    override fun initializeComponent() {
        ...
        ApplicationManager.getApplication().messageBus.connect(this)
            .subscribe<ProjectManagerListener>(
    ...
    companion object {
        ...
        fun getServerWithConsoleProcess(project: Project): LanguageServerEndpoint {
            return psConsoleLanguageServer.computeIfAbsent(project) {
                LanguageServerEndpoint(
                    PowerShellConsoleTerminalRunner(it),
                    it,
                )
            }
        }
        ...
        private fun getEditorLanguageServer(project: Project): LanguageServerEndpoint {
            return psEditorLanguageServer.computeIfAbsent(project) {
                LanguageServerEndpoint(
                    EditorServicesLanguageHostStarter(it),
                    it,
                )
            }
        }
