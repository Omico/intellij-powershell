...
class LSPWrapperPsiElementImpl(
    private val myName: String,
    private val myParent: PsiElement,
    kind: CompletionItemKind?,
) : FakePsiElement(), LSPWrapperPsiElement {
    ...
    constructor(
        ...
        if (StringUtil.isEmpty(completionItem.label)) completionItem.insertText else completionItem.label,
        parent,
        completionItem.kind,
    ) {
