...
open class EditorServicesLanguageHostStarter(protected val myProject: Project) : LanguageHostConnectionManager {
    ...
    companion object {
        ...
        private val myHostDetails = HostDetails(
            ApplicationNamesInfo.getInstance().fullProductName,
            "com.intellij.plugin.PowerShell",
            getHostVersion(),
        )
        ...
        private open class SessionInfo private constructor(
            protected val powerShellVersion: String?,
            protected val status: String?,
        ) {

            class Pipes internal constructor(
                internal val languageServiceReadPipeName: String,
            ...
            class Tcp internal constructor(
                internal val languageServicePort: Int,
    ...
    private fun checkOutput(process: Process, editorServicesVersion: String): Boolean {
        ...
        if ("needs_install" == result) {
            val content =
                "Required $editorServicesVersion 'PowerShellEditorServices' module is not found. Please install PowerShell VS Code extension"
            val title = "PowerShellEditorServices $editorServicesVersion module not found."
            val notify = Notification(
                "PowerShell Extension Not Found",
                PowerShellIcons.FILE,
                title,
                null,
                content,
            ...
            notify.addAction(
                BrowseNotificationAction(
                    ...
                    MessagesBundle.message("powershell.vs.code.extension.install.link"),
                ),
            )
    ...
    private fun readPipesInfo(jsonResult: JsonObject): SessionInfo? {
        ...
        return SessionInfo.Pipes(
            langServiceReadPipeName,
            langServiceWritePipeName,
            debugServiceReadPipeName,
    ...
    private fun createLogPath(psExtensionPath: String): String =
        FileUtil.toCanonicalPath("$psExtensionPath/sessions/${getLogFileName()}.log")
}
