...
public class FormUIUtil {
  ...
  public static String getEditorServicesVersion(@NotNull final String editorServicesDir)
    ...
    try {
      editorServicesVersion =
          INSTANCE.getEditorServicesModuleVersion(
              INSTANCE.getPSExtensionModulesDir(editorServicesDir));
    } catch (PowerShellExtensionError e) {
      PowerShellConfigurable.LOG.warn(
          "Error detecting PowerShell Editor Services module version: " + e.getMessage(), e);
      throw new ConfigurationException(
          "Can not detect Editor Services module version" + e.getMessage());
    }
  ...
  @Contract("null -> fail")
  public static void validatePowerShellExecutablePath(@Nullable String powerShellExePath)
      throws ConfigurationException {
  ...
  public static TextFieldWithBrowseButton createTextFieldWithBrowseButton(
      @NotNull String description, JBTextField field, FileChooserDescriptor fileChooserDescriptor) {
    ...
    FileChooserFactory.getInstance()
        .installFileCompletion(textField, fileChooserDescriptor, true, null);
  ...
  public static String getGlobalSettingsExecutablePath() {
    return ApplicationManager.getApplication()
        .getComponent(LSPInitMain.class)
        .getState()
